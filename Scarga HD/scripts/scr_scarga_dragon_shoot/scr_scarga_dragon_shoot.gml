...
with(instance_create(x + (14 * x_side) + x_xprev,y - 17 + vsp,obj_fx_scarga_shoot)){
                           
                                  sprite_index = spr_scarga_dragon_shoot_effect; 
         ...
         if (blaster_charged >= 30 && blaster_charged < 60){
                        ...
                        with(instance_create(x + (5 * x_side) + x_xprev,y - 19,obj_scarga_bullet)){
                           
                                  image_xscale = other.x_side;
                                  hspeed = (4 * image_xscale);
                                  
                                  sprite_index = spr_scarga_dragon_charged_bullet;
                                  image_speed = 0.15;
                                  image_index = 0;
                         ...
                         with(instance_create(x + x_xprev ,y - 20 ,obj_scarga_bullet)){
                           
                                  image_xscale = other.x_side;
                                  hspeed = (5 * image_xscale);
                                  
                                  sprite_index = spr_scarga_dragon_super_charged_bullet;
                                  image_speed = 0.15;
                                  image_index = 0;
                         ...
                         with(instance_create(x + (7 * x_side) + x_xprev,y - 15,obj_scarga_bullet)){
                           
                                  image_xscale = other.x_side;
                                  hspeed = (3.5 * image_xscale);
                                  
                                  sprite_index = spr_scarga_dragon_bullet;
                                  image_speed = 0.15;
                                  image_index = 0;
